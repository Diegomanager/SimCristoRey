...
public class EstadoSimulacionDTO {
    ...
    private List<SocioDTO> sociosEnEsperaList;
    ...
    public List<SocioDTO> getSociosEnEsperaList() { return sociosEnEsperaList; }
    public void setSociosEnEsperaList(List<SocioDTO> sociosEnEsperaList) { this.sociosEnEsperaList = sociosEnEsperaList; }
}