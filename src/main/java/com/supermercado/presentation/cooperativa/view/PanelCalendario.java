...
/**
 * Calendario visual con colores de fondo completo en cada boton, botones de
 * accion rapida (todo laborable / todo libre / restablecer) y leyenda.
 */
public class PanelCalendario extends JPanel {
    ...
    private final JLabel  lblResumen = new JLabel("Dias laborables: 0");

    private static final Color C_LABORABLE     = new Color(100, 200, 100);
    private static final Color C_NO_LABORABLE  = new Color(230, 100, 100);
    private static final Color C_SABADO_LAB    = new Color(100, 150, 220);
    private static final Color C_SABADO_NOLAB  = new Color(160, 180, 230);
    private static final Color C_DOMINGO_LAB   = new Color(200, 150, 200);
    private static final Color C_DOMINGO_NOLAB = new Color(190, 190, 190);
    private static final Color C_HOY           = new Color(255, 220, 50);
    ...
    public PanelCalendario() {
        ...
        nav.add(btnPrev);
        nav.add(new JLabel("Ano:")); nav.add(spnAnio);
        ...
        leyenda.add(cuadro(C_SABADO_LAB,    "Sabado lab."));
    ...
    public void refrescarCalendario() {
        ...
        String[] cabeceras = {"Lun","Mar","Mie","Jue","Vie","Sab","Dom"};
    ...
    private void actualizarResumen() {
        ...
        lblResumen.setText("Dias laborables: " + labs);
    }
    ...
    /**
     * Restaura los ESTADOS de dias desde persistencia, sin mover la vista
     * del calendario (se queda en el mes/anio actual).
     */
